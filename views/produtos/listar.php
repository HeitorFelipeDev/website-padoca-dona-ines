...
<body
    class="font-sans overflow-x-hidden scroll-smooth transition-all bg-[url('../../assets/images/logo-background.png')] bg-no-repeat bg-right">

    <header class="header border border-color-secondary bg-white">
        ...
        <div class="header-container flex items-center justify-between px-14">
            ...
            <seaction class="section-assets-header-container flex gap-4">
                ...
                <button
                    class="button-bag bg-color-light rounded-full w-12 h-12 flex items-center justify-center relative">
                    <span
                ...
                <button
                    class="button-login border rounded-full w-12 h-12 flex items-center justify-center transition-all border-color-secondary text-color-secondary hover:border-red-600 hover:text-red-600">
	...
	<h1 class="text-2xl font-bold text-color-primary px-14 mt-2 p-6">Categorias</h1>

	<article class="flex justify-start gap-5 mt-2 px-14"></article>

    <div class="container px-14 p-6">

		<h1 class="text-2xl font-bold mb-6 mt-2 text-color-primary">Produtos Disponíveis</h1>

        <div id="produtos" class="grid grid-cols-5 gap-6">
